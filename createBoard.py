...
def create_full_board(board_info, size_square_mm, scale=1.0):
    ...
    _3d_corners = _2d_corner * size_square_mm
    _2d_corners = _2d_corner * block_size_px
    _3d_corners = convert2homography(_3d_corners, 0.0)
    _2d_corners = convert2homography(_2d_corners, 0.0)
    ...
    _3d_patch_corners = _2d_patch_corner * size_square_mm
    _2d_patch_corners = _2d_patch_corner * block_size_px
    _3d_patch_corners = convert2homography(_3d_patch_corners, 0.0)
    _2d_patch_corners = convert2homography(_2d_patch_corners, 0.0)
    ...
    _3d_circle_centers = _2d_circle * size_square_mm
    _2d_circle_centers = _2d_circle * block_size_px
    _3d_circle_centers = convert2homography(_3d_circle_centers, 0.0)
    _2d_circle_centers = convert2homography(_2d_circle_centers, 0.0)
    ...
    board_info_['rec2d_corners'] = _2d_corners
    board_info_['rec3d_corners'] = _3d_corners
    
    board_info_['cir2d'] = _2d_circle_centers
    board_info_['cir3d'] = _3d_circle_centers
    board_info_['radius'] = _2d_circle_radius
    
    board_info_['patch2d'] = _2d_patch_corners
    board_info_['patch3d'] = _3d_patch_corners
